...
<div>
    <x-header title="Rekap Bulanan" separator progress-indicator>
        <x-slot:actions>
            <a href="{{ route('absen.rekap-bulanan.pdf', ['bulan' => $bulan, 'tahun' => $tahun, 'search' => $search]) }}" target="_blank" class="btn btn-error btn-sm text-white">
