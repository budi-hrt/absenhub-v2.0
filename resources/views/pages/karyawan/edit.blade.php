...
new class extends Component {
    ...
    public function rules(): array
    {
        return [
            ...
            'pinMesin' => 'nullable|integer|unique:karyawans,pin_mesin,' . $this->karyawanId,
        ];
    }
...
<div>
    <x-header title="Edit Karyawan" subtitle="Perbarui informasi karyawan di bawah ini." separator />
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-3 flex flex-col items-center gap-4">
                    <div class="w-40 h-40 rounded-xl border-2 border-dashed border-base-300 overflow-hidden bg-base-200 flex flex-col items-center justify-center relative group">
                        ...
                        @elseif ($existingFoto)
                            <img src="{{ Storage::url($existingFoto) }}" class="absolute inset-0 w-full h-full object-cover" />
                        @else
