...
<?php $component = Mary\View\Components\Modal::resolve(['title' => 'Kelola Permission: '.e($selectedRoleName).'','subtitle' => 'Centang permission yang ingin diberikan ke role ini','boxClass' => '!w-11/12 !max-w-xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'permissionModal']); ?>
...
<?php endif; ?>
                <span class="text-sm font-medium">
                    <span class="text-primary font-bold"><?php echo e(count($selectedPermissions)); ?></span>
                    <span class="text-base-content/60">/ <?php echo e($totalCount); ?> permission dipilih</span>
                </span>
            </div>
            <div class="badge badge-primary badge-lg">
                <?php echo e(count($selectedPermissions)); ?>/<?php echo e($totalCount); ?>
...
<?php endif; ?>
        ...
        <div class="mb-4 flex items-center justify-between p-3 bg-primary/5 border border-primary/20 rounded-xl">
            ...
            <span class="text-xs text-base-content/60">
                <?php echo e(count($selectedPermissions)); ?>/<?php echo e($totalCount); ?> terpilih
            </span>
        </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $groupedPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div class="border border-base-300 rounded-xl overflow-hidden transition-all hover:border-primary/30">
                    ...
                    <div class="flex items-center justify-between p-3 bg-base-100 cursor-pointer select-none
                        <?php echo e($isFullySelected ? 'bg-primary/5' : ''); ?>"
                        wire:click="toggleGroup('<?php echo e($group); ?>')">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="badge <?php echo e($isFullySelected ? 'badge-primary' : ($groupSelected > 0 ? 'badge-warning' : 'badge-soft')); ?> badge-sm">
                    ...
                    <div class="border-t border-base-200 p-3 grid grid-cols-1 sm:grid-cols-2 gap-1 bg-base-50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <label class="flex items-center gap-2 p-2 rounded-lg cursor-pointer transition-all
                                hover:bg-base-200/50 <?php echo e(in_array($permission->id, $selectedPermissions) ? 'bg-primary/5' : ''); ?>">
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Simpan','spinner' => 'syncPermissions'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-primary','wire:click' => 'syncPermissions']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views/livewire/permission-modal.blade.php ENDPATH**/ ?>