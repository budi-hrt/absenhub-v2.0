...
<?php endif; ?>
                    ...
                    <?php if($money): ?>
                        <div
                            class="w-full"
                            x-data="{
                                amount: $wire.get('<?php echo e($modelName()); ?>'),
                                currency: null,
                                init() {
                                    $nextTick(() => this.currency = new Currency($refs.myInput, <?php echo e($moneySettings()); ?>))
                                    $watch('$wire.<?php echo e($modelName()); ?>', (value) => {
...
</div><?php /**PATH C:\laragon\www\absenhub-v2.0\storage\framework\views/dbbb47d339389d79d169070048727b8a.blade.php ENDPATH**/ ?>