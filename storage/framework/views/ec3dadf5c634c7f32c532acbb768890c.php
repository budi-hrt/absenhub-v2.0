    <?php foreach ((['lift', 'box', 'labelClass', 'contentClass', 'activeClass']) as $__key => $__value) {
    ...
    <div>
        <label
            ...
            :class="{ '<?php echo e($activeClass); ?>': selected === '<?php echo e($name); ?>' }"
        >
            <input id="<?php echo e(($id ?? $uuid).$name); ?>" type="radio" name="<?php echo e(($id ?? $uuid).$name); ?>" value="<?php echo e($name); ?>" x-model="selected" />
...
<?php $component = Mary\View\Components\Badge::resolve(['value' => $badge] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses(['badge-sm badge-soft', $badgeClass]))]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <div
            x-show="selected == '<?php echo e($name); ?>'"
            <?php echo e($attributes->class(["tab-content py-5 px-3 border-t-base-content/10 block rounded-none", $contentClass])); ?>

         >
            <?php echo e($slot); ?>

        </div>
    </div><?php /**PATH C:\laragon\www\absenhub-v2.0\storage\framework\views/0738d4d98eb0f3d22230ee1cbab72edd.blade.php ENDPATH**/ ?>