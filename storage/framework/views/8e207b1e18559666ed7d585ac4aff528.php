...
<?php $component = Mary\View\Components\Icon::resolve(['name' => 'o-table-cells'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <a x-bind:href="'/karyawan/export/pdf?search=' + encodeURIComponent($wire.search)
                ...
                <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
<?php $component = Mary\View\Components\Icon::resolve(['name' => 'o-document'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component = Mary\View\Components\Modal::resolve(['boxClass' => '!max-w-xl !p-0'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <div class="bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-5 rounded-t-xl">
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-white/70"><?php echo e($detail->jabatan?->nama_jabatan ?? '-'); ?></p>
...
<?php endif; ?>
                            <span class="text-xs text-white/60">
                                Lama Kerja: <span class="font-semibold text-white"><?php echo e($lamaKerja); ?></span>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <?php if($nk): ?>
            <div class="bg-gradient-to-r from-red-500 to-rose-700 text-white px-6 py-5 rounded-t-xl">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-bold text-lg"><?php echo e($nk->nama_karyawan); ?></div>
                        <div class="text-xs text-white/70">NIK: <?php echo e($nk->nik); ?></div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
