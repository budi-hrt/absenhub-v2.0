...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Riwayat Absensi','separator' => true,'progressIndicator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Select::resolve(['label' => 'Bulan','options' => collect($months)->map(fn($name, $id) => ['id' => $id, 'name' => $name]),'optionValue' => 'id','optionLabel' => 'name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'bulan']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginald64144c2287634503c73cd4803d6e578 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald64144c2287634503c73cd4803d6e578 = $attributes; } ?>
<?php $component = Mary\View\Components\Select::resolve(['label' => 'Tahun','options' => collect($years)->map(fn($year) => ['id' => $year, 'name' => $year]),'optionValue' => 'id','optionLabel' => 'name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Select::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'tahun']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Lihat Data','icon' => 'o-magnifying-glass','spinner' => 'cari'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'btn-primary w-full shadow-sm']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <?php if($isSearched): ?>
        <div class="space-y-3 mb-24">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $riwayatAbsen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                ?>
                <div class="flex items-center gap-4 p-4 bg-base-100 rounded-2xl border-l-4 <?php echo e($borderColor); ?> border-y border-r border-base-200 hover:shadow-md transition-shadow">
                    <div class="flex flex-col items-center justify-center min-w-[50px] md:min-w-[60px]">
                        <span class="text-2xl md:text-3xl font-bold text-base-content"><?php echo e(Carbon::parse($absen->tanggal_absen)->format('d')); ?></span>
                        <span class="text-[10px] md:text-xs text-base-content/50 uppercase font-semibold"><?php echo e(Carbon::parse($absen->tanggal_absen)->locale('id')->isoFormat('MMM')); ?></span>
                    </div>
                    
                    <div class="flex-1 min-w-0 border-l border-base-200 pl-4 md:pl-5">
                        <div class="flex flex-wrap items-center justify-between gap-2 mb-2">
                            <span class="text-xs md:text-sm text-base-content/70 font-semibold"><?php echo e(Carbon::parse($absen->tanggal_absen)->locale('id')->isoFormat('dddd, D MMMM Y')); ?></span>
                            <div class="badge <?php echo e($badgeClass); ?> badge-sm md:badge-md text-[10px] md:text-xs"><?php echo e($absen->keterangan); ?></div>
                        </div>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-3.5 h-3.5 text-base-content/50']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                ...
                                <p class="text-sm md:text-base font-bold text-base-content"><?php echo e($absen->jam_masuk ? Carbon::parse($absen->jam_masuk)->format('H:i') : '--:--'); ?></p>
                            </div>
                            <div>
                                <div class="flex items-center gap-1.5 mb-0.5">
                                    <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
<?php $component = Mary\View\Components\Icon::resolve(['name' => 'o-arrow-left-on-rectangle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                ...
                                <p class="text-sm md:text-base font-bold text-base-content"><?php echo e($absen->jam_keluar ? Carbon::parse($absen->jam_keluar)->format('H:i') : '--:--'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views\pages\karyawan\riwayat.blade.php ENDPATH**/ ?>