...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Dashboard Karyawan','separator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <div>
                    <div class="text-2xl font-bold"><?php echo e(auth()->user()->name); ?></div>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 text-warning shrink-0']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                <div>
                    <div class="text-2xl font-bold"><?php echo e(auth()->user()->karyawan?->jabatan?->nama_jabatan ?? '-'); ?></div>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 text-success shrink-0']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                <div>
                    <div class="text-2xl font-bold"><?php echo e(auth()->user()->is_active ? 'Aktif' : 'Nonaktif'); ?></div>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 mx-auto mb-3 text-base-content/30']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php unset($__componentOriginalce0070e6ae017cca68172d0230e44821); ?>
<?php endif; ?>
            <p class="text-sm">Selamat datang di AbsenHub, <strong><?php echo e(auth()->user()->name); ?></strong></p>
...
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views\pages\karyawan\dashboard.blade.php ENDPATH**/ ?>