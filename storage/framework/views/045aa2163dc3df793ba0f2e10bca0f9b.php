...
<?php endif; ?>
    ...
    <div class="bg-base-100 border rounded-xl overflow-hidden shadow-sm relative">
        
        <div wire:loading wire:target="search, tahun, perPage, gotoPage, nextPage, previousPage" class="absolute inset-0 bg-base-100/30 backdrop-blur-[1px] z-50 rounded-xl transition-all duration-150">
        ...
        <div wire:loading.class="opacity-25 pointer-events-none" wire:target="search, tahun, perPage, gotoPage, nextPage, previousPage" class="transition-opacity duration-150">
...
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views\pages\absen\rekap-tahunan.blade.php ENDPATH**/ ?>