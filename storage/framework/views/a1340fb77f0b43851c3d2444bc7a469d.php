...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 -mb-1.5 text-purple-500']); ?>
...
<?php endif; ?>
        ...
        <div class="display-when-collapsed hidden mx-5 mt-5 mb-1 h-[28px]">
            <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
<?php $component = Mary\View\Components\Icon::resolve(['name' => 's-cube'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\absenhub-v2.0\storage\framework\views/af53b77cb1777ae4ce6abb82f970c4e5.blade.php ENDPATH**/ ?>