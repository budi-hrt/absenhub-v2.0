<div id="<?php echo e($anchor); ?>" <?php echo e($attributes->class(["mb-10", "mary-header-anchor" => $withAnchor])); ?>>
    <div class="flex flex-wrap gap-5 justify-between items-center">
        <div>
            <?php echo "<{$titleTag}"; ?> class="<?php echo \Illuminate\Support\Arr::toCssClasses(["flex", "items-center", "$size $weight", is_string($title) ? '' : $title?->attributes->get('class') ]); ?>" >
                <?php if($withAnchor): ?>
...
<?php endif; ?>
    ...
    <?php if($separator): ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\absenhub-v2.0\storage\framework\views/19f352ee93e8747cd9fd6e6deaa4dfb1.blade.php ENDPATH**/ ?>