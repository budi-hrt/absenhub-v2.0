...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-error text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
            ...
            <div>
                ...
                <div x-data="{ show: false }" class="join w-full">
                    ...
                    <button type="button" x-on:click="show = !show"
                        ...
                        <span x-show="!show"><?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
<?php $component = Mary\View\Components\Icon::resolve(['name' => 'o-eye-slash'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views\pages\⚡login.blade.php ENDPATH**/ ?>