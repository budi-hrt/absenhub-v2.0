...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Pengajuan Izin / Cuti','separator' => true,'progressIndicator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div>
                    <p class="text-xs text-base-content/60 font-semibold uppercase tracking-wider">Jatah Cuti <?php echo e(now()->year); ?></p>
                    <p class="text-2xl font-bold text-base-content"><?php echo e($jatahCuti->jatah_cuti); ?> <span class="text-sm font-normal text-base-content/60">hari</span></p>
                </div>
            </div>
        </div>
...
<?php endif; ?>
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-base-content"><?php echo e($terpakai); ?> <span class="text-sm font-normal text-base-content/60">hari</span></p>
                </div>
            </div>
        </div>
...
<?php endif; ?>
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-success"><?php echo e($sisaCuti); ?> <span class="text-sm font-normal text-base-content/60">hari</span></p>
                </div>
            </div>
        </div>
    </div>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => $showForm ? 'Batal' : 'Buat Pengajuan Baru','icon' => $showForm ? 'o-x-mark' : 'o-plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'toggleForm','class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('shadow-sm')]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Mary\View\Components\Card::resolve(['title' => 'Form Pengajuan'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-6 border border-base-300 shadow-sm']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Mary\View\Components\Select::resolve(['label' => 'Jenis Pengajuan','options' => $jenisOptions,'optionValue' => 'id','optionLabel' => 'name','placeholder' => 'Pilih jenis...'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'jenis']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'tambahTanggal','class' => 'btn-sm btn-ghost mt-2 border border-base-300']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'keterangan','placeholder' => 'Tulis alasan pengajuan Anda...','rows' => '3']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Mary\View\Components\File::resolve(['label' => 'Lampiran (Surat Dokter / Bukti)','hint' => 'Opsional. Maks 2MB. Format: JPG, PNG.'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="flex justify-end pt-2">
                <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Kirim Pengajuan','icon' => 'o-paper-airplane','spinner' => 'submit'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'btn-primary shadow-sm']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <div class="space-y-3 mb-24">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pengajuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            ?>
            <div class="bg-base-100 rounded-2xl border-l-4 <?php echo e($borderColor); ?> border-y border-r border-base-200 p-4 hover:shadow-md transition-shadow">
                <div class="flex flex-wrap items-center justify-between gap-2 mb-3">
                    <div class="flex items-center gap-2">
                        <div class="badge <?php echo e($jenisBadge); ?> badge-sm md:badge-md font-semibold"><?php echo e($p->jenis); ?></div>
                        <span class="text-xs text-base-content/50"><?php echo e($p->jumlah_hari); ?> hari</span>
                    </div>
                    <div class="badge <?php echo e($statusBadge); ?> badge-sm md:badge-md font-semibold"><?php echo e($p->status); ?></div>
                </div>
                ...
                <div class="bg-base-200/50 p-3 rounded-xl mb-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if(is_array($p->tanggal)): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $p->tanggal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tgl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <p class="text-xs md:text-sm text-base-content/70 mb-2">
                    <span class="font-semibold">Alasan:</span> <?php echo e($p->keterangan); ?>
                ...
                <div class="bg-error/10 text-error text-xs md:text-sm p-3 rounded-xl mt-2">
                    <span class="font-semibold">Alasan ditolak:</span> <?php echo e($p->alasan_tolak); ?>

                </div>
                <?php endif; ?>

                <p class="text-[10px] text-base-content/40 mt-2">Diajukan: <?php echo e(Carbon::parse($p->created_at)->locale('id')->isoFormat('D MMMM Y, HH:mm')); ?></p>
            </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            <div class="text-center py-12 bg-base-100 rounded-2xl border border-base-200 shadow-sm">
                <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
<?php $component = Mary\View\Components\Icon::resolve(['name' => 'o-document-plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 text-base-content/30']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views\pages\karyawan\pengajuan.blade.php ENDPATH**/ ?>