        ...
        >
            ...
            <thead class="<?php echo \Illuminate\Support\Arr::toCssClasses(["text-base-content", "hidden" => $noHeaders]); ?>">
                <tr x-ref="headers">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $headers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                         <?php
                        ...
                        <th
                            ...
                            <?php if($sortBy && $isSortable($header)): ?>
                                @click="$wire.set('<?php echo e($sortByProperty); ?>', {column: '<?php echo e($getSort($header)['column']); ?>', direction: '<?php echo e($getSort($header)['direction']); ?>' })"
                            <?php endif; ?>
                        >
                            <?php echo e(isset(${"header_".$temp_key}) ? ${"header_".$temp_key}($header) : $header['label']); ?>


                            <?php if($isSortable($header)): ?>
...
<?php endif; ?>
            ...
            <!-- ROWS -->
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr
                    ...
                    >
                        ...
                        <?php if($expandable): ?>
                            <td class="w-1 pe-0 py-0">
                                <?php if(data_get($row, $expandableCondition)): ?>
                                    <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
<?php endif; ?>
            <?php endif; ?>
        <?php endif; ?>
    </div><?php /**PATH C:\laragon\www\absenhub-v2.0\storage\framework\views/3efdd21eec3c77e7031d1e52cd7e3def.blade.php ENDPATH**/ ?>