...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Dashboard','separator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <div>
                    <div class="text-2xl font-bold"><?php echo e(\App\Models\User::count()); ?></div>
...
<?php endif; ?>
                <div>
                    <div class="text-2xl font-bold"><?php echo e(\App\Models\User::role('admin')->count()); ?></div>
...
<?php endif; ?>
                <div>
                    <div class="text-2xl font-bold"><?php echo e(\App\Models\User::role('manager')->count()); ?></div>
