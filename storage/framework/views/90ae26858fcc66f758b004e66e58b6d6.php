...
<?php $component = Mary\View\Components\Table::resolve(['headers' => [['key' => 'name', 'label' => 'Name']],'rows' => [['name' => 'Jane']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_name', function($row) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
        <span class="text-success">Hello <?php echo e($row['name']); ?></span>
    <?php }); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\absenhub-v2.0\storage\framework\views/99cb260dfcc00d0680c57b048eef0ea1.blade.php ENDPATH**/ ?>