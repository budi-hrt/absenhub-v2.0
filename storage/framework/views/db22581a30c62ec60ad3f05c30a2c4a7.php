...
<head>
    <meta charset="utf-8">
    <title>Rekap Bulanan - <?php echo e($namaBulan); ?> <?php echo e($tahun); ?></title>
    <style>
        @page { margin: 10mm; }
...
<body>
    <h2>Rekap Absensi Bulanan Karyawan</h2>
    ...
    <div class="info">
        <table>
            <tr>
                <td style="width: 50%">
                    <span>Periode:</span> <?php echo e($namaBulan); ?> <?php echo e($tahun); ?>
...
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views/exports/rekap-bulanan-pdf.blade.php ENDPATH**/ ?>