...
<head>
    <meta charset="UTF-8">
    <title>Surat Perjanjian Kerja - <?php echo e($kontrak->nomor); ?></title>
    <style>
        @page {
...
<body>
    ...
    <div class="header-box">
        <img src="<?php echo e(public_path('logo/logo.png')); ?>" class="logo" alt="Logo" onerror="this.style.display='none'"><br>
    ...
    <div class="title-section">
        ...
        <div class="doc-number">Nomor : <?php echo e($kontrak->nomor); ?></div>
    </div>

    <p style="margin-left: 15px;">Pada hari ini, <?php echo e($tanggalSuratFormat); ?> telah dibuat dan disepakati perjanjian kerja antara :</p>
    ...
    <table class="table-data" style="margin-left: 30px; width: 95%;">
        <tr>
            ...
            <td><?php echo e(strtoupper($kontrak->penandatangan?->nama_penandatangan ?? 'SHELLY RUDYANI')); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Alamat</td>
            <td>:</td>
            <td><?php echo e($kontrak->penandatangan?->alamat ?? 'JL. ZEBRA 1A NO.93 PALU'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Jabatan</td>
            <td>:</td>
            <td><?php echo e(strtoupper(is_string($kontrak->penandatangan?->jabatan) ? $kontrak->penandatangan->jabatan : ($kontrak->penandatangan?->jabatan?->nama_jabatan ?? 'DIREKTUR'))); ?></td>
        </tr>
    </table>
    ...
    <table class="table-data" style="margin-left: 30px; width: 95%;">
        <tr>
            ...
            <td style="width: 180px;">Nama</td>
            <td style="width: 15px;">:</td>
            <td><?php echo e(strtoupper($kontrak->karyawan?->nama_karyawan)); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Tempat /Tanggal lahir</td>
            <td>:</td>
            <td><?php echo e(strtoupper($kontrak->karyawan?->tempat_lahir ?? '-')); ?> <?php echo e($kontrak->karyawan?->tanggal_lahir ? \Carbon\Carbon::parse($kontrak->karyawan->tanggal_lahir)->format('d F Y') : '-'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Pendidikan Terakhir</td>
            <td>:</td>
            <td><?php echo e(strtoupper($kontrak->karyawan?->pendidikan ?? 'S1')); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Jenis Kelamin</td>
            <td>:</td>
            <td><?php echo e(($kontrak->karyawan?->jk_karyawan === 'L' || $kontrak->karyawan?->jk_karyawan === 'Laki-laki') ? 'Laki -laki' : 'Perempuan'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Agama</td>
            <td>:</td>
            <td><?php echo e(ucfirst($kontrak->karyawan?->agama_karyawan ?? '-')); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Alamat</td>
            <td>:</td>
            <td><?php echo e($kontrak->karyawan?->alamat_karyawan ?? '-'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>No. KTP / SIM</td>
            <td>:</td>
            <td><?php echo e($kontrak->karyawan?->nik ?? '-'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>Telephone</td>
            <td>:</td>
            <td><?php echo e($kontrak->karyawan?->telp_karyawan ?? '-'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>No Rek Bank Mandiri</td>
            <td>:</td>
            <td><?php echo e($kontrak->karyawan?->rekening && $kontrak->karyawan->rekening !== '0' ? $kontrak->karyawan->rekening : '..................................................'); ?></td>
        </tr>
    </table>
    <p class="indent-p" style="margin-top: 4px; margin-bottom: 10px;">
    ...
    <table class="table-data" style="margin-left: 30px; width: 95%;">
        ...
        <tr>
            ...
            <td style="width: 15px;">:</td>
            <td><?php echo e(strtoupper($kontrak->masaKontrak?->status_kontrak ?? 'INTERNSHIP ( 1 ) SATU TAHUN')); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>- Masa Kontrak</td>
            <td>:</td>
            <td><?php echo e($tanggalMulaiFormat); ?> - <?php echo e($tanggalAkhirFormat); ?></td>
        </tr>
        <tr>
            <td></td>
            <td>- Jabatan</td>
            <td>:</td>
            <td><?php echo e($kontrak->karyawan?->jabatan?->nama_jabatan ?? '-'); ?></td>
        </tr>
    </table>
    ...
    <table class="table-data" style="margin-left: 30px; width: 95%; margin-top: 4px;">
        ...
        <tr>
            ...
            <td style="width: 15px;">:</td>
            <td>Rp. <?php echo e($kontrak->gaji > 0 ? number_format($kontrak->gaji, 0, ',', '.') : '..................'); ?> / Bulan.</td>
        </tr>
        <tr>
            <td></td>
            <td>Tunjangan</td>
            <td>:</td>
            <td>Rp. <?php echo e($kontrak->tunjangan > 0 ? number_format($kontrak->tunjangan, 0, ',', '.') : '..................'); ?> / Bulan ( sesuai posisi/ daerah ).</td>
        </tr>
    </table>
    ...
    <table class="table-data" style="margin-left: 30px; width: 95%; margin-top: 4px;">
        <tr>
            ...
            <td>PIHAK KEDUA berhak atas uang makan sebesar Rp <?php echo e(number_format($kontrak->um_dalamkota, 0, ',', '.')); ?>,-perhari (dalam kota) atau Rp. <?php echo e(number_format($kontrak->um_luarkota, 0, ',', '.')); ?>,- perhari (luar kota) sesuai jumlah kehadiran.</td>
        </tr>
    </table>
    ...
    <table class="table-data" style="margin-top: 15px; margin-left: 15px;">
        ...
        <tr>
            <td>Tanggal</td>
            <td>:</td>
            <td><?php echo e($tanggalSuratFormat); ?></td>
        </tr>
    </table>
    ...
    <table class="ttd-table">
        ...
        <tr>
            <td>( <u><strong><?php echo e(strtoupper($kontrak->penandatangan?->nama_penandatangan ?? 'SHELLY RUDYANI')); ?></strong></u> )</td>
            <td>( <u><strong><?php echo e(strtoupper($kontrak->karyawan?->nama_karyawan)); ?></strong></u> )</td>
        </tr>
    </table>

</body>
</html>
<?php /**PATH C:\laragon\www\absenhub-v2.0\resources\views\exports\kontrak-pdf.blade.php ENDPATH**/ ?>